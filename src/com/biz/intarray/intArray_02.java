...
public class intArray_02 {
	...
	public static void main(String[] args) {
		...
		// 총점을 계산하는 부분은
		// 거의 코드가 유사한데
		// 끝에 숫자 2자리만 연속에 1씩 증가되고 있는 것을 확인
		// 그렇다면 앞에 학습한 for 명령을 이용하여 새로운 코드를
		// 작성할수 있을 것이다.
		int intSum = 0;
		for(int i = 1; i <30;i++) {
			//intSum += intKor_i;
		...
		int intNum_03 = 0;
		// 우리가 생각할때
		// 아래코드는 intNum_03 = 100이라고 번역될것으로
		// 보이지만 컴퓨터가 인식하지 못하는 문법이다.
		//		intNum_a = 100;
		
		// 아래코드 또한 intNum + a 는 intNum_03 이라고 번역될 것으로
